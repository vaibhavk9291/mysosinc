    ...
    <div className="flex flex-col w-full min-h-screen">
      <section className="bg-brand-light py-20 border-b border-brand-navy/5">
        <div className="container mx-auto px-6 lg:px-12 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-brand-navy mb-6">Desklodge, Bristol</h1>
          ...
          <p className="max-w-2xl mx-auto text-lg text-brand-text/80 leading-relaxed">
            Massage services available across both Desklodge sites in Bristol.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 flex-1 bg-white">
        <div className="container mx-auto px-6 lg:px-12 flex flex-col items-center">
          <AppointmentScheduler
            ...
            meetingTitle="Treatment at Desklodge, Bristol"
